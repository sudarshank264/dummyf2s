...
const About = () => {
  ...
  const renderAboutText = () => {
    ...
    return content.aboutUsText.split('\n').filter(p => p.trim() !== '').map((p, i) => (
      <p key={i} style={{ color: 'var(--grey)', marginTop: i === 0 ? '20px' : '12px', lineHeight: 1.85, fontSize: '0.93rem' }}>
        {p}
      </p>
    ));
  };
  return (
    <section className="section about-bg" id="about" style={{ paddingBottom: 0 }}>
